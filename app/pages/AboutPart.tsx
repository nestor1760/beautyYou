      ...
      <div className='flex items-start justify-between w-full max-w-[1110px]'>
        ...
        <div className='flex items-end justify-between h-[659px] flex-col flex-grow'>
          ...
          <div className='max-w-[542px] max-h-[252px] text-end'>
            <h2 className='text-[32px] mb-[60px] italic leading-10 uppercase'>Creating beauty with attention to every detail</h2>
            <p className='text-[16px] leading-4 text-end'>Hello! I&lsquo;m Sara, your brow artist with 6 years of experience. <br />My mission is to enhance your natural beauty through perfectly shaped brows. Join me for a session where every detail matters, and your satisfaction is the goal. You can expect personalized attention and customized solutions tailored to your unique brow needs and preferences. With my dedication and passion for beauty, I strive to exceed your expectations and leave you feeling empowered and confident in your look.</p>
          </div>
          <Button />
        </div>
      </div>
